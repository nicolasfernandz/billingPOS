# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-09-20 00:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_cierre_Caja', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
            name='Caja',
        ...
        migrations.AddField(
            model_name='aperturacaja',
            name='Dia',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gallery.Dia'),
        ),
    ]
